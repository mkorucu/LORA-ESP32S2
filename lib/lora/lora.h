...
#define CONFIG_RST_GPIO GPIO_NUM_5
#define CONFIG_CS_GPIO  GPIO_NUM_6
#define CONFIG_MISO_GPIO    GPIO_NUM_7
#define CONFIG_MOSI_GPIO    GPIO_NUM_8
#define CONFIG_SCK_GPIO     GPIO_NUM_9
